...
<body>
  ...
  <div class="container">
    <img src="exclusive.jpeg" alt="Room 1" class="room-image" />

    <h1>Room 3 - Exclusive Private Karaoke</h1>
    <p>Room 3 menawarkan suasana nyaman dan akustik terbaik untuk pengalaman karaoke yang menyenangkan bersama teman atau keluarga. Cocok untuk grup kecil hingga menengah.</p>

    <div class="price">IDR 200.000 / jam</div>
...
<input type="time" id="end_time" name="end_time" required>
      ...
      <select id="room-type" name="room_type" required>
        <option value="R. Exclusive">R. Exclusive</option>
      </select>
